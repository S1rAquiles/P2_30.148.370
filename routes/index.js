...
router.get('/2003', function(req, res, next) {
  res.render('2003', {title: 'programacion 2',nombre:"javier suarez",   ANALITYCS_KEY:process.env.ANALITYCS_KEY,});
});
