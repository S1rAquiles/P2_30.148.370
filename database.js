...
let db = new sqlite3.Database(':memory:',(err) => {
  ...
  module.exports = {
    insert: function (name, email, comment, Datetime, myIP, country) {
        db.run("INSERT INTO contactos (name, email,  comment, date, ip, country) VALUES (?,  ?, ?, ?, ?, ?)", [name, email,  comment, Datetime, myIP, country], function (err) {
            if (err) {
